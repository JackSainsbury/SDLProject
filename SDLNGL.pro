...
SOURCES+= $$PWD/src/*.cpp \
          $$PWD/src/Components/*.cpp \
          $$PWD/src/MapHandling/*.cpp \

# same for the .h files
HEADERS+= $$PWD/include/*.h \
          $$PWD/include/Components/*.h \
          $$PWD/include/MapHandling/*.h \

# and add the include dir into the search path for Qt and make
INCLUDEPATH +=./include ./include/Components ./include/MapHandling
